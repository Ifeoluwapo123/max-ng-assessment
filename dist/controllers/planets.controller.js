...
PlanetsController.getMovieCharacters = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { data, status } = yield movies_api_1.default.getFilmById(Number(req.params.id));
    if (status == 200) {
        const value = helperFunction_1.mapOutUnwantedFields([data], apiFilterKeys_1.planetsKey);
